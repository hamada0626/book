<div class="categories index">
	<h2><?php echo __('カテゴリー'); ?></h2>
	<table cellpadding="0" cellspacing="0">
	<thead>
	<tr>
			<th><?php echo $this->Paginator->sort('id'); ?></th>
			<th><?php echo $this->Paginator->sort('name','カテゴリー名'); ?></th>
			<th><?php echo $this->Paginator->sort('used','使用フラグ'); ?></th>
			<th><?php echo $this->Paginator->sort('created','登録年月日'); ?></th>
			<th><?php echo $this->Paginator->sort('modified','更新年月日'); ?></th>
